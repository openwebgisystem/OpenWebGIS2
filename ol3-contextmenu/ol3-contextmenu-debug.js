...
Html.prototype.addMenuEntry = function addMenuEntry (item) {
  ...
  if (item.items && Array.isArray(item.items)) {
    ...
    li.appendChild(ul);
ul.parentNode.onclick=function(){if(ul.style.visibility=='hidden'||!ul.style.visibility){ul.style.visibility='visible';ul.style.opacity=1;ul.style.webkitTransitionDelay='0s';
            ul.style.transitionDelay='0s';}else{ul.style.visibility='hidden';ul.style.opacity=0;} } 
